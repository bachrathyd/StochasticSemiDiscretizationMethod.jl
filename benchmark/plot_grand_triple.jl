...
#   row 1 = spectral radius ρ(H)      (data: grand_orders_pub.csv)
#   row 2 = stationary 2nd moment Var (data: grand_orders_fix.csv)
...
const ROWS = [
    (csv="grand_orders_pub.csv", floor=2e-11, ylab="|ρ − ρ_ref|",
     tag="(spectral radius)"),
    (csv="grand_orders_fix.csv", floor=5e-11, ylab="|Var(q) − Var_ref|",
...
dst = raw"D:\BD\ssdm-ps\journal_paper\images"
